...
import WeaponCommand from "./weapon/WeaponCommand"
import WeaponSkillHover from "./weapon/WeaponSkillHover"
import WeaponSkillIcon from "./weapon/WeaponSkillIcon"
...
export default function WeaponGrid({ weapons = [], weapon_skills = [] }) {
